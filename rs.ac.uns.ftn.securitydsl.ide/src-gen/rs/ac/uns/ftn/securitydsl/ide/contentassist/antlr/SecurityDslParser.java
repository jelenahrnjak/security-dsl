...
public class SecurityDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SecurityDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAttributeAccess().getIsIdentifierAssignment_1(), "rule__Attribute__IsIdentifierAssignment_1");
			...
			builder.put(grammarAccess.getRoleInstanceAccess().getNameAssignment_1(), "rule__RoleInstance__NameAssignment_1");
