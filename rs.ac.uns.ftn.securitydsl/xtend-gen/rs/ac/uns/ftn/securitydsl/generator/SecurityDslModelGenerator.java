...
public class SecurityDslModelGenerator {
  public SecurityDslModelGenerator(final Resource resource, final IFileSystemAccess2 fsa, final Application app, final String srcDestination) {
    ...
    if (_hasNext) {
      ...
      fsa.generateFile((srcDestination + "/model/User.java"), this.generateUserModel(app.getPackageName(), user));
    }
  ...
  public String generateUserModel(final String appMainPackage, final User user) {
    ...
    _builder_4.append("    ");
    _builder_4.append("public void setPassword(String password) {");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("Timestamp now = new Timestamp(new Date().getTime());");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("this.setLastPasswordResetDate(now);");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("this.password = password;");
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("}");
    _builder_4.newLine();
    ...
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("return this.roles;");
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("}");
    _builder_4.newLine();
    ...
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("return enabled;");
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("}");
    _builder_4.newLine();
  ...
  public Attribute getStringAttributeForRole(final List<Attribute> unsortedAttributes) {
    ...
    for (final Attribute a : unsortedAttributes) {
      boolean _isIsIdentifier = a.isIsIdentifier();
      if (_isIsIdentifier) {
        attributes.add(0, a);
      } else {
        attributes.add(a);
