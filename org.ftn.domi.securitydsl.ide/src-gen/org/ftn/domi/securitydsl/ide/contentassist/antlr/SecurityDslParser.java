 ...
 */
package org.ftn.domi.securitydsl.ide.contentassist.antlr;
...
import org.ftn.domi.securitydsl.ide.contentassist.antlr.internal.InternalSecurityDslParser;
...
public class SecurityDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SecurityDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getClaimsAccess().getAlternatives(), "rule__Claims__Alternatives");
			...
			builder.put(grammarAccess.getUserAccess().getGroup_6(), "rule__User__Group_6__0");
			builder.put(grammarAccess.getUserAccess().getGroup_6_3(), "rule__User__Group_6_3__0");
			builder.put(grammarAccess.getOtherModelAccess().getGroup(), "rule__OtherModel__Group__0");
			builder.put(grammarAccess.getOtherModelAccess().getGroup_7(), "rule__OtherModel__Group_7__0");
			builder.put(grammarAccess.getOtherModelAccess().getGroup_7_3(), "rule__OtherModel__Group_7_3__0");
			...
			builder.put(grammarAccess.getRoleAccess().getGroup_6_3(), "rule__Role__Group_6_3__0");
			builder.put(grammarAccess.getEndpointAccess().getGroup(), "rule__Endpoint__Group__0");
			builder.put(grammarAccess.getEndpointAccess().getGroup_8(), "rule__Endpoint__Group_8__0");
			builder.put(grammarAccess.getEndpointAccess().getGroup_8_3(), "rule__Endpoint__Group_8_3__0");
			...
			builder.put(grammarAccess.getAuthenticationAccess().getGroup_8(), "rule__Authentication__Group_8__0");
			...
			builder.put(grammarAccess.getPublicClaimsAccess().getGroup(), "rule__PublicClaims__Group__0");
			builder.put(grammarAccess.getPrivateClaimsAccess().getGroup(), "rule__PrivateClaims__Group__0");
			...
			builder.put(grammarAccess.getUserAccess().getIdentifierNameAssignment_3(), "rule__User__IdentifierNameAssignment_3");
			builder.put(grammarAccess.getUserAccess().getIdentifierTypeAssignment_5(), "rule__User__IdentifierTypeAssignment_5");
			builder.put(grammarAccess.getUserAccess().getModel_attributesAssignment_6_2(), "rule__User__Model_attributesAssignment_6_2");
			builder.put(grammarAccess.getUserAccess().getModel_attributesAssignment_6_3_1(), "rule__User__Model_attributesAssignment_6_3_1");
			builder.put(grammarAccess.getOtherModelAccess().getNameAssignment_1(), "rule__OtherModel__NameAssignment_1");
			builder.put(grammarAccess.getOtherModelAccess().getIdentifierNameAssignment_4(), "rule__OtherModel__IdentifierNameAssignment_4");
			builder.put(grammarAccess.getOtherModelAccess().getIdentifierTypeAssignment_6(), "rule__OtherModel__IdentifierTypeAssignment_6");
			builder.put(grammarAccess.getOtherModelAccess().getModel_attributesAssignment_7_2(), "rule__OtherModel__Model_attributesAssignment_7_2");
			builder.put(grammarAccess.getOtherModelAccess().getModel_attributesAssignment_7_3_1(), "rule__OtherModel__Model_attributesAssignment_7_3_1");
			builder.put(grammarAccess.getRoleAccess().getIdentifierNameAssignment_3(), "rule__Role__IdentifierNameAssignment_3");
			builder.put(grammarAccess.getRoleAccess().getIdentifierTypeAssignment_5(), "rule__Role__IdentifierTypeAssignment_5");
			builder.put(grammarAccess.getRoleAccess().getModel_attributesAssignment_6_2(), "rule__Role__Model_attributesAssignment_6_2");
			builder.put(grammarAccess.getRoleAccess().getModel_attributesAssignment_6_3_1(), "rule__Role__Model_attributesAssignment_6_3_1");
			builder.put(grammarAccess.getEndpointAccess().getUrlAssignment_3(), "rule__Endpoint__UrlAssignment_3");
			builder.put(grammarAccess.getEndpointAccess().getFunction_nameAssignment_5(), "rule__Endpoint__Function_nameAssignment_5");
			builder.put(grammarAccess.getEndpointAccess().getMethodAssignment_7(), "rule__Endpoint__MethodAssignment_7");
			builder.put(grammarAccess.getEndpointAccess().getRoles_authorityAssignment_8_2(), "rule__Endpoint__Roles_authorityAssignment_8_2");
			builder.put(grammarAccess.getEndpointAccess().getRoles_authorityAssignment_8_3_1(), "rule__Endpoint__Roles_authorityAssignment_8_3_1");
			...
			builder.put(grammarAccess.getAuthenticationAccess().getSignup_endpointAssignment_6_1(), "rule__Authentication__Signup_endpointAssignment_6_1");
			builder.put(grammarAccess.getAuthenticationAccess().getLogin_endpointAssignment_7_1(), "rule__Authentication__Login_endpointAssignment_7_1");
			builder.put(grammarAccess.getAuthenticationAccess().getLogout_endpointAssignment_8_1(), "rule__Authentication__Logout_endpointAssignment_8_1");
			builder.put(grammarAccess.getOtherControllerAccess().getNameAssignment_1(), "rule__OtherController__NameAssignment_1");
			...
			builder.put(grammarAccess.getPublicClaimsAccess().getIsPublicAssignment_0(), "rule__PublicClaims__IsPublicAssignment_0");
			builder.put(grammarAccess.getPublicClaimsAccess().getNameAssignment_1(), "rule__PublicClaims__NameAssignment_1");
			builder.put(grammarAccess.getPrivateClaimsAccess().getIsPublicAssignment_0(), "rule__PrivateClaims__IsPublicAssignment_0");
			builder.put(grammarAccess.getPrivateClaimsAccess().getNameAssignment_1(), "rule__PrivateClaims__NameAssignment_1");
		}
	}
