...
public class SecurityDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SecurityDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRegisteredClaimAccess().getGroup(), "rule__RegisteredClaim__Group__0");
			builder.put(grammarAccess.getRegisteredClaimAccess().getGroup_5(), "rule__RegisteredClaim__Group_5__0");
			builder.put(grammarAccess.getRegisteredClaimAccess().getGroup_6(), "rule__RegisteredClaim__Group_6__0");
			...
			builder.put(grammarAccess.getJWTAccess().getRegistered_claimsAssignment_7(), "rule__JWT__Registered_claimsAssignment_7");
			...
			builder.put(grammarAccess.getRegisteredClaimAccess().getExpirationTimeAssignment_3(), "rule__RegisteredClaim__ExpirationTimeAssignment_3");
			builder.put(grammarAccess.getRegisteredClaimAccess().getIssuerAssignment_5_4(), "rule__RegisteredClaim__IssuerAssignment_5_4");
			builder.put(grammarAccess.getRegisteredClaimAccess().getAudienceAssignment_6_4(), "rule__RegisteredClaim__AudienceAssignment_6_4");
