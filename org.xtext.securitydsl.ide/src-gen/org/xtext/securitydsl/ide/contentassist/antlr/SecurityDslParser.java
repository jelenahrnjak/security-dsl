...
public class SecurityDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SecurityDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getApplicationAccess().getGroup_12_2(), "rule__Application__Group_12_2__0");
			builder.put(grammarAccess.getApplicationAccess().getGroup_13(), "rule__Application__Group_13__0");
			builder.put(grammarAccess.getApplicationAccess().getGroup_14(), "rule__Application__Group_14__0");
			builder.put(grammarAccess.getApplicationAccess().getGroup_14_1(), "rule__Application__Group_14_1__0");
			...
			builder.put(grammarAccess.getApplicationAccess().getArtifactAssignment_3(), "rule__Application__ArtifactAssignment_3");
			builder.put(grammarAccess.getApplicationAccess().getNameAssignment_4_1(), "rule__Application__NameAssignment_4_1");
			builder.put(grammarAccess.getApplicationAccess().getGroupAssignment_6(), "rule__Application__GroupAssignment_6");
			builder.put(grammarAccess.getApplicationAccess().getPackageNameAssignment_7_1(), "rule__Application__PackageNameAssignment_7_1");
			builder.put(grammarAccess.getApplicationAccess().getDescriptionAssignment_8_1(), "rule__Application__DescriptionAssignment_8_1");
			...
			builder.put(grammarAccess.getEndpointAccess().getMethodNameAssignment_6(), "rule__Endpoint__MethodNameAssignment_6");
			builder.put(grammarAccess.getEndpointAccess().getMethodAssignment_7_1(), "rule__Endpoint__MethodAssignment_7_1");
			builder.put(grammarAccess.getEndpointAccess().getRole_authoritiesAssignment_8_2(), "rule__Endpoint__Role_authoritiesAssignment_8_2");
			builder.put(grammarAccess.getEndpointAccess().getRole_authoritiesAssignment_8_3_1(), "rule__Endpoint__Role_authoritiesAssignment_8_3_1");
			...
			builder.put(grammarAccess.getJWTAccess().getSignatureAlgorithmAssignment_2(), "rule__JWT__SignatureAlgorithmAssignment_2");
			builder.put(grammarAccess.getJWTAccess().getSecretAssignment_4(), "rule__JWT__SecretAssignment_4");
			builder.put(grammarAccess.getJWTAccess().getClaimsAssignment_7(), "rule__JWT__ClaimsAssignment_7");
			builder.put(grammarAccess.getJWTAccess().getClaimsAssignment_8_1(), "rule__JWT__ClaimsAssignment_8_1");
			builder.put(grammarAccess.getClaimAccess().getTypeAssignment_1(), "rule__Claim__TypeAssignment_1");
			builder.put(grammarAccess.getClaimAccess().getNameAssignment_3(), "rule__Claim__NameAssignment_3");
			builder.put(grammarAccess.getClaimAccess().getValueAssignment_5(), "rule__Claim__ValueAssignment_5");
			builder.put(grammarAccess.getClaimAccess().getClaim_attributeAssignment_6_1(), "rule__Claim__Claim_attributeAssignment_6_1");
