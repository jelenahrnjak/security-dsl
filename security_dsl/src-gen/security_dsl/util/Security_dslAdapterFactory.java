...
public class Security_dslAdapterFactory extends AdapterFactoryImpl {
	...
	protected Security_dslSwitch<Adapter> modelSwitch = new Security_dslSwitch<Adapter>() {
		...
		@Override
		public Adapter caseClaims(Claims object) {
			return createClaimsAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link security_dsl.Claims <em>Claims</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createClaimsAdapter() {
		return null;
	}
