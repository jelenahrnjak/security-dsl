...
public class Security_dslSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Security_dslPackage.JWT_SECURITY: {
			JwtSecurity jwtSecurity = (JwtSecurity) theEObject;
			T result = caseJwtSecurity(jwtSecurity);
			if (result == null)
				result = caseSecurity(jwtSecurity);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Security_dslPackage.CLAIMS: {
			Claims claims = (Claims) theEObject;
			T result = caseClaims(claims);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case Security_dslPackage.OTHER_MODEL: {
			OtherModel otherModel = (OtherModel) theEObject;
			T result = caseOtherModel(otherModel);
			if (result == null)
				result = caseModel(otherModel);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case Security_dslPackage.OTHER_CONTROLLER: {
			OtherController otherController = (OtherController) theEObject;
			T result = caseOtherController(otherController);
			if (result == null)
				result = caseController(otherController);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Jwt Security</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Jwt Security</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseJwtSecurity(JwtSecurity object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Claims</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Claims</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseClaims(Claims object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Other Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Other Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOtherModel(OtherModel object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Other Controller</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Other Controller</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOtherController(OtherController object) {
		return null;
	}
