...
public class UserImpl extends EntityImpl implements User {
	 ...
	 * @generated
	 */
	public boolean oneCredentialForUser(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "User::oneCredentialForUser";
		try {
			/**
			 *
			 * inv oneCredentialForUser:
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					Security_dslPackage.Literals.USER___ONE_CREDENTIAL_FOR_USER__DIAGNOSTICCHAIN_MAP);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case Security_dslPackage.USER___ONE_CREDENTIAL_FOR_USER__DIAGNOSTICCHAIN_MAP:
			return oneCredentialForUser((DiagnosticChain) arguments.get(0), (Map<Object, Object>) arguments.get(1));
