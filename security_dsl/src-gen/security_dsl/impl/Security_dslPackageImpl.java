...
public class Security_dslPackageImpl extends EPackageImpl implements Security_dslPackage {
	 ...
	 * @generated
	 */
	private EClass claimsEClass = null;
	 ...
	 * @generated
	 */
	public EAttribute getClaims_IsPublic() {
		return (EAttribute) claimsEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getClaims_Name() {
		return (EAttribute) claimsEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getAuthentication__UniqueAuthEndpoint__DiagnosticChain_Map() {
	...
	public EOperation getAuthentication__MethodsAllowedLogin__DiagnosticChain_Map() {
		return authenticationEClass.getEOperations().get(4);
	}
	...
	public void createPackageContents() {
		...
		claimsEClass = createEClass(CLAIMS);
		createEAttribute(claimsEClass, CLAIMS__IS_PUBLIC);
		createEAttribute(claimsEClass, CLAIMS__NAME);
		...
		createEOperation(authenticationEClass, AUTHENTICATION___UNIQUE_AUTH_ENDPOINT__DIAGNOSTICCHAIN_MAP);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getSecurity_Mechanism(), this.getESecurityMechanism(), "mechanism", "JWT", 1, 1, Security.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getJwtSecurity_Secret(), ecorePackage.getEString(), "secret", null, 1, 1, JwtSecurity.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getJwtSecurity_Security_claims(), this.getClaims(), null, "security_claims", null, 0, -1,
		...
		initEClass(claimsEClass, Claims.class, "Claims", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClaims_IsPublic(), ecorePackage.getEBoolean(), "isPublic", null, 1, 1, Claims.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClaims_Name(), ecorePackage.getEString(), "name", null, 1, 1, Claims.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getAuthentication__UniqueAuthEndpoint__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"uniqueAuthEndpoint", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation(authenticationEClass, source, new String[] { "constraints", "methodsAllowedLogin" });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation(getAuthentication__UniqueAuthEndpoint__DiagnosticChain_Map(), source, new String[] { "body",
				" self.signup_endpoint.url <> self.login_endpoint.url <> self.logout_endpoint.url" });
