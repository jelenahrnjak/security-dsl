...
public class JwtSecurityImpl extends SecurityImpl implements JwtSecurity {
	 ...
	 * @ordered
	 */
	protected EList<Claims> security_claims;
	 ...
	 * @generated
	 */
	public EList<Claims> getSecurity_claims() {
		if (security_claims == null) {
			security_claims = new EObjectContainmentEList<Claims>(Claims.class, this,
	...
	public boolean uniqueClaims(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			if (le) {
				...
				final /*@NonInvalid*/ List<Claims> security_claims = this.getSecurity_claims();
				final /*@NonInvalid*/ OrderedSetValue BOXED_security_claims = idResolver
						.createOrderedSetOfAll(Security_dslTables.ORD_CLSSid_Claims, security_claims);
				/*@Thrown*/ Accumulator accumulator = ValueUtil
						.createSetAccumulatorValue(Security_dslTables.ORD_CLSSid_Claims);
				...
				while (true) {
					...
					/*@NonInvalid*/ Claims c = (Claims) ITERATOR_c.next();
					/**
					 * c.name
					 */
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Security_dslPackage.JWT_SECURITY__SECURITY_CLAIMS:
			...
			getSecurity_claims().addAll((Collection<? extends Claims>) newValue);
			return;
		}
