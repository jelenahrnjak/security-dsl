...
public interface Security_dslPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link security_dsl.impl.ClaimsImpl <em>Claims</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see security_dsl.impl.ClaimsImpl
	 * @see security_dsl.impl.Security_dslPackageImpl#getClaims()
	 * @generated
	 */
	int CLAIMS = 6;
	...
	/**
	 * The number of structural features of the '<em>Claims</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CLAIMS_FEATURE_COUNT = 2;

	/**
	 * The number of operations of the '<em>Claims</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CLAIMS_OPERATION_COUNT = 0;
	 ...
	 * @ordered
	 */
	int AUTHENTICATION___METHODS_ALLOWED_LOGOUT__DIAGNOSTICCHAIN_MAP = CONTROLLER_OPERATION_COUNT + 1;

	/**
	 * The operation id for the '<em>Unique Auth Endpoint</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int AUTHENTICATION___UNIQUE_AUTH_ENDPOINT__DIAGNOSTICCHAIN_MAP = CONTROLLER_OPERATION_COUNT + 2;
	 ...
	 * @ordered
	 */
	int AUTHENTICATION___URL_STARTS_WITH_FORWARD_SLASH__DIAGNOSTICCHAIN_MAP = CONTROLLER_OPERATION_COUNT + 3;
	 ...
	 * @ordered
	 */
	int AUTHENTICATION___METHODS_ALLOWED_LOGIN__DIAGNOSTICCHAIN_MAP = CONTROLLER_OPERATION_COUNT + 4;
	 ...
	 * @ordered
	 */
	int AUTHENTICATION_OPERATION_COUNT = CONTROLLER_OPERATION_COUNT + 5;
	...
	/**
	 * Returns the meta object for class '{@link security_dsl.Claims <em>Claims</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Claims</em>'.
	 * @see security_dsl.Claims
	 * @generated
	 */
	EClass getClaims();

	/**
	 * Returns the meta object for the attribute '{@link security_dsl.Claims#isIsPublic <em>Is Public</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Is Public</em>'.
	 * @see security_dsl.Claims#isIsPublic()
	 * @see #getClaims()
	 * @generated
	 */
	EAttribute getClaims_IsPublic();

	/**
	 * Returns the meta object for the attribute '{@link security_dsl.Claims#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see security_dsl.Claims#getName()
	 * @see #getClaims()
	 * @generated
	 */
	EAttribute getClaims_Name();
	...
	/**
	 * Returns the meta object for the '{@link security_dsl.Authentication#uniqueAuthEndpoint(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Unique Auth Endpoint</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Unique Auth Endpoint</em>' operation.
	 * @see security_dsl.Authentication#uniqueAuthEndpoint(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getAuthentication__UniqueAuthEndpoint__DiagnosticChain_Map();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link security_dsl.impl.ClaimsImpl <em>Claims</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see security_dsl.impl.ClaimsImpl
		 * @see security_dsl.impl.Security_dslPackageImpl#getClaims()
		 * @generated
		 */
		EClass CLAIMS = eINSTANCE.getClaims();
		 ...
		 * @generated
		 */
		EAttribute CLAIMS__IS_PUBLIC = eINSTANCE.getClaims_IsPublic();
		 ...
		 * @generated
		 */
		EAttribute CLAIMS__NAME = eINSTANCE.getClaims_Name();
		...
		/**
		 * The meta object literal for the '<em><b>Unique Auth Endpoint</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation AUTHENTICATION___UNIQUE_AUTH_ENDPOINT__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getAuthentication__UniqueAuthEndpoint__DiagnosticChain_Map();
