...
public class Security_dslTables extends AbstractTables
{
	...
	public static class Types {
		...
		public static final EcoreExecutorType _Claim = new EcoreExecutorType(Security_dslPackage.Literals.CLAIM, PACKAGE, 0 | ExecutorType.ABSTRACT);
		...
		public static final EcoreExecutorType _Private = new EcoreExecutorType(Security_dslPackage.Literals.PRIVATE, PACKAGE, 0);
		public static final EcoreExecutorType _Public = new EcoreExecutorType(Security_dslPackage.Literals.PUBLIC, PACKAGE, 0);
	...
	public static class Fragments {
		...
		private static final ExecutorFragment _Private__Claim = new ExecutorFragment(Types._Private, Security_dslTables.Types._Claim);
		private static final ExecutorFragment _Private__OclAny = new ExecutorFragment(Types._Private, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _Private__OclElement = new ExecutorFragment(Types._Private, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _Private__Private = new ExecutorFragment(Types._Private, Security_dslTables.Types._Private);

		private static final ExecutorFragment _Public__Claim = new ExecutorFragment(Types._Public, Security_dslTables.Types._Claim);
		private static final ExecutorFragment _Public__OclAny = new ExecutorFragment(Types._Public, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _Public__OclElement = new ExecutorFragment(Types._Public, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _Public__Public = new ExecutorFragment(Types._Public, Security_dslTables.Types._Public);
	...
	public static class Properties {
		...
		public static final ExecutorProperty _Claim__name = new EcoreExecutorProperty(Security_dslPackage.Literals.CLAIM__NAME, Types._Claim, 0);
		public static final ExecutorProperty _Claim__JwtSecurity__security_claims = new ExecutorPropertyWithImplementation("JwtSecurity", Types._Claim, 1, new EcoreLibraryOppositeProperty(Security_dslPackage.Literals.JWT_SECURITY__SECURITY_CLAIMS));
	...
	public static class TypeFragments {
		...
		private static final ExecutorFragment /*@NonNull*/ [] _Private =
			{
				Fragments._Private__OclAny /* 0 */,
				Fragments._Private__OclElement /* 1 */,
				Fragments._Private__Claim /* 2 */,
				Fragments._Private__Private /* 3 */
			};
		private static final int /*@NonNull*/ [] __Private = { 1,1,1,1 };

		private static final ExecutorFragment /*@NonNull*/ [] _Public =
			{
				Fragments._Public__OclAny /* 0 */,
				Fragments._Public__OclElement /* 1 */,
				Fragments._Public__Claim /* 2 */,
				Fragments._Public__Public /* 3 */
			};
		private static final int /*@NonNull*/ [] __Public = { 1,1,1,1 };
	...
	public static class FragmentOperations {
		...
		private static final ExecutorOperation /*@NonNull*/ [] _Private__Private = {};
		private static final ExecutorOperation /*@NonNull*/ [] _Private__Claim = {};
		private static final ExecutorOperation /*@NonNull*/ [] _Private__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _Private__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclAsModelType /* oclAsModelType(TT)(TT[1]) */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _Public__Public = {};
		private static final ExecutorOperation /*@NonNull*/ [] _Public__Claim = {};
		private static final ExecutorOperation /*@NonNull*/ [] _Public__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _Public__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclAsModelType /* oclAsModelType(TT)(TT[1]) */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */,
		...
		static {
			...
			Fragments._Private__Claim.initOperations(_Private__Claim);
			...
			Fragments._Public__Claim.initOperations(_Public__Claim);
	...
	public static class FragmentProperties {
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Private = {
			Security_dslTables.Properties._Claim__name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};

		private static final ExecutorProperty /*@NonNull*/ [] _Public = {
			Security_dslTables.Properties._Claim__name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
