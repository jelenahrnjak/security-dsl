...
public class SecurityDslJWTGenerator {
  ...
  public String generateWebSecurityConfig(final String packageName, final Authentication authController) {
    ...
    _builder.append("import ");
    _builder.append(packageName);
    _builder.append(".service.impl.CustomUserDetailsService;");
    _builder.newLineIfNotEmpty();
    _builder.append("import ");
    _builder.append(packageName);
    ...
    _builder.append("import org.springframework.context.annotation.Configuration;");
    _builder.newLine();
    _builder.append("import org.springframework.context.annotation.Lazy;");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public PasswordEncoder passwordEncoder() {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("private CustomUserDetailsService customUserDetailsService;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("@Autowired");
    ...
    _builder.newLine();
    _builder.append("                ");
    _builder.append(".userDetailsService(customUserDetailsService)");
    _builder.newLine();
    _builder.append("                ");
    ...
    _builder.newLine();
    _builder.append("                ");
    _builder.append(".addFilterBefore(new TokenAuthenticationFilter(tokenUtils, customUserDetailsService), BasicAuthenticationFilter.class);");
    _builder.newLine();
    _builder.newLine();
    _builder.append("        ");
