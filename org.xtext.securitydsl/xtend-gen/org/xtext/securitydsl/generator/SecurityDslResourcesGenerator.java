...
public class SecurityDslResourcesGenerator {
  ...
  public String generatePomXml(final Application app) {
    ...
    String _plus_7 = (_builder_10.toString() + databaseDependency);
    StringConcatenation _builder_11 = new StringConcatenation();
    String _plus_8 = (_plus_7 + _builder_11);
    String _plus_9 = (_plus_8 + securityDependency);
    StringConcatenation _builder_12 = new StringConcatenation();
    String _plus_10 = (_plus_9 + _builder_12);
    ...
    _builder_13.newLine();
    _builder_13.append("\t\t\t\t");
    _builder_13.append("<groupId>org.projectlombok</groupId>");
    _builder_13.newLine();
    _builder_13.append("\t\t\t\t");
    _builder_13.append("<artifactId>lombok</artifactId>");
    _builder_13.newLine();
    _builder_13.append("\t\t\t\t");
    _builder_13.append("<optional>true</optional>");
    _builder_13.newLine();
    _builder_13.append("\t\t\t");
    _builder_13.append("</dependency>");
    _builder_13.newLine();
    ...
    _builder_13.newLine();
    _builder_13.append("\t\t\t\t");
    _builder_13.append("<artifactId>spring-boot-starter-test</artifactId>");
    _builder_13.newLine();
    _builder_13.append("\t\t\t\t");
    _builder_13.append("<scope>test</scope>");
    _builder_13.newLine();
    _builder_13.append("\t\t\t");
    _builder_13.append("</dependency>");
    _builder_13.newLine();
    ...
    _builder_13.newLine();
    _builder_13.append("\t\t\t\t");
    _builder_13.append("<groupId>org.modelmapper</groupId>");
    _builder_13.newLine();
    _builder_13.append("\t\t\t\t");
    _builder_13.append("<artifactId>modelmapper</artifactId>");
    _builder_13.newLine();
    _builder_13.append("\t\t\t\t");
    _builder_13.append("<version>2.4.4</version>");
    _builder_13.newLine();
    _builder_13.append("\t\t\t");
    _builder_13.append("</dependency>");
    _builder_13.newLine();
    ...
    _builder_13.newLine();
    _builder_13.append("\t\t\t\t\t");
    _builder_13.append("<artifactId>spring-boot-maven-plugin</artifactId>");
    _builder_13.newLine();
    _builder_13.append("\t\t\t\t\t");
    _builder_13.append("<configuration>");
    _builder_13.newLine();
    _builder_13.append("\t\t\t\t\t\t");
    _builder_13.append("<excludes>");
    _builder_13.newLine();
    _builder_13.append("\t\t\t\t\t\t\t");
    _builder_13.append("<exclude>");
    _builder_13.newLine();
    _builder_13.append("\t\t\t\t\t\t\t\t");
    _builder_13.append("<groupId>org.projectlombok</groupId>");
    _builder_13.newLine();
    ...
    _builder_13.append("\t");
    _builder_13.newLine();
    content = (_content_2 + _builder_13);
    return content;
  }
