...
public class SecurityDslResourcesGenerator {
  ...
  public String generatePomXml(final Application app) {
    ...
    content = (_content_1 + databaseDependency);
    ...
    _builder_9.newLine();
    _builder_9.append("\t\t\t\t");
    _builder_9.append("<groupId>org.projectlombok</groupId>");
    _builder_9.newLine();
    _builder_9.append("\t\t\t\t");
    _builder_9.append("<artifactId>lombok</artifactId>");
    _builder_9.newLine();
    _builder_9.append("\t\t\t\t");
    _builder_9.append("<optional>true</optional>");
    _builder_9.newLine();
    _builder_9.append("\t\t\t");
    _builder_9.append("</dependency>");
    _builder_9.newLine();
    ...
    _builder_9.newLine();
    _builder_9.append("\t\t\t\t");
    _builder_9.append("<artifactId>spring-boot-starter-test</artifactId>");
    _builder_9.newLine();
    _builder_9.append("\t\t\t\t");
    _builder_9.append("<scope>test</scope>");
    _builder_9.newLine();
    _builder_9.append("\t\t\t");
    _builder_9.append("</dependency>");
    _builder_9.newLine();
    ...
    _builder_9.newLine();
    _builder_9.append("\t\t\t\t");
    _builder_9.append("<groupId>org.modelmapper</groupId>");
    _builder_9.newLine();
    _builder_9.append("\t\t\t\t");
    _builder_9.append("<artifactId>modelmapper</artifactId>");
    _builder_9.newLine();
    _builder_9.append("\t\t\t\t");
    _builder_9.append("<version>2.4.4</version>");
    _builder_9.newLine();
    _builder_9.append("\t\t\t");
    _builder_9.append("</dependency>");
    _builder_9.newLine();
    ...
    _builder_9.newLine();
    _builder_9.append("\t\t\t\t\t");
    _builder_9.append("<artifactId>spring-boot-maven-plugin</artifactId>");
    _builder_9.newLine();
    _builder_9.append("\t\t\t\t\t");
    _builder_9.append("<configuration>");
    _builder_9.newLine();
    _builder_9.append("\t\t\t\t\t\t");
    _builder_9.append("<excludes>");
    _builder_9.newLine();
    _builder_9.append("\t\t\t\t\t\t\t");
    _builder_9.append("<exclude>");
    _builder_9.newLine();
    _builder_9.append("\t\t\t\t\t\t\t\t");
    _builder_9.append("<groupId>org.projectlombok</groupId>");
    _builder_9.newLine();
